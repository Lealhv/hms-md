...
class SuppliersController
{
    ...
    public function create()
    {
        ...
        foreach ($data as $supplier) {
            $query = "INSERT INTO suppliers (SP_id, SP_name) VALUES (?, ?)"; // הוסף SP_id לשאילתא
            ...
            // קבע את הערכים ל-SP_id ו-SP_name
            $stmt->bind_param("is", $supplier->SP_id, $supplier->SP_name);

            if ($stmt->execute()) {
                $responses[] = ["message" => "Supplier created successfully", "SP_id" => $supplier->SP_id];
            } else {
